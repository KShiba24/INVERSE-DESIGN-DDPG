...
class Trained_Agent:
    def __init__(self, state_size, a_list, c_list, ta_list, tc_list, action_size, action_high, action_low):
        #initialize actor
        w1 = a_list[0]
        b1 = a_list[1]
        w2 = a_list[2]
        ...
        tb3 = ta_list[5]
        self.actor_network = ActorNetwork(w1, b1, w2, b2, w3, b3, actor_learning_rate, action_high, action_low)
        self.target_actor_network = TargetActorNetwork(tw1, tb1, tw2, tb2, tw3, tb3, actor_learning_rate, action_high, action_low)
        #initialize critic
        w1 = c_list[0]
        b1 = c_list[1]
        w2 = c_list[2]
        ...
        tb3 = tc_list[5]
        self.critic_network = CriticNetwork(w1, b1, w2, b2, w3, b3, critic_learning_rate)
        self.target_critic_network = TargetCriticNetwork(tw1, tb1, tw2, tb2, tw3, tb3, critic_learning_rate)
